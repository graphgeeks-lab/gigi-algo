...
Adapters call the engine. They never reimplement it -- if this file ever
...
# assumed, because these values are exactly what makes engines disagree.
...
def run(graph, params):
    ...
    if weight_property is None:
        weight = ENGINE_DEFAULT_WEIGHT  # the engine's default, made visible
